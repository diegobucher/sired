...
public class ReportUtils {
    ...
    /**
     * Converte o <code>stream</code> informado para um array de bytes de um arquivo do tipo XLS.
     * 
     * @param stream
     *            Stream do relatório jasper
     * @param parametros
     *            Parâmetros a ser enviado para o relatório
     * @param dataSource
     *            Dados utilizados no preenchimento do relatório
     * @return
     * @throws JRException
     *             Caso haja algum erro no preenchimento do relatório
     */
    private byte[] toXLS(InputStream stream, Map<String, Object> parametros, Object dataSource) throws JRException {
    ...
    private byte[] toDocx(InputStream stream, Map<String, Object> parametros, Object dataSource) throws JRException {
        ByteArrayOutputStream streamArray = new ByteArrayOutputStream();
        JasperPrint print = null;
    ...
    private byte[] obterRelatorio(String caminhoJasper, String arquivoJasper, HashMap<String, Object> parametros, List<?> colecaoDataSource, String tipo)
            throws Exception {
    ...
    public byte[] obterRelatorio(InputStream is, HashMap<String, Object> parametros, List<?> colecaoDataSource, String tipo) throws Exception {
        ...
        if (tipo.equals(REL_TIPO_PDF)) {
            relatorio = JasperRunManager.runReportToPdf(is, parametros, ds instanceof JRBeanCollectionDataSource ? (JRBeanCollectionDataSource) ds
                    : (JREmptyDataSource) ds);
    ...
    public byte[] obterRelatorio(InputStream is, HashMap<String, Object> parametros, List<?> colecaoDataSource, String tipo, Connection conexao)
            throws Exception {
        if (is == null) {
            throw new Exception("ReportUtils.obterRelatorio(InputStream, HashMap, List, String) : InputStream enviado é nulo");
        }
        ...
        if (tipo.equals(REL_TIPO_PDF)) {
            relatorio = JasperRunManager.runReportToPdf(is, parametros, conexao);
    ...
    /**
     * Retorna um array de bytes de um arquivo do tipo XLS correspondente ao jasper informado através do <code>arquivoJasper</code>.
     * 
     * @param caminhoJasper
     * @param arquivoJasper
     * @param parametros
     ...
     * 
     * @param relatorio
     *            array de bytes a ser escrito
     * @param nomeRelatorio
     *            nome de saída do arquivo no cliente
     * @param httpServletResponse
     *            objeto HTTP contendo o stream de resposta.
     * @throws Exception
     * @throws IOException
     */
