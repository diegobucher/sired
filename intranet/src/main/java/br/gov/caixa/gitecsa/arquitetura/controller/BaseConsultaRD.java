...
public abstract class BaseConsultaRD<T extends BaseEntity> extends AppBaseController {
    ...
    /**
     * Sufixo do nome tela que o controller está vinculada, Isso serve Para tornar possível voltar para tela chamadora.
     * 
     * @return
     */
    ...
    /**
     * Procura mensagem no contexto(sessão) e caso exista adiciona no facesMessager e limpa o contexto
     */
