...
public class ContextoController implements Serializable {
    ...
    /**
     * Método usado para guardar o id do componente que chamou o evento. Esse método será usado normalmente em botões que chamam dialogs
     */
    ...
    /**
     * Este método trabalha em conjunto com o método guardarIdComponente. Também será usado normalmente junto com os dialogs. Quando o
     * dialog for fechado este método dará foco no botão que chamou o dialog.
     * 
    ...
    /**
     * Método responsável por armazenar o nome da tela, que será utilizada para voltar a tela chamadadora ao clicar em voltar
     * 
     * @return
     */
