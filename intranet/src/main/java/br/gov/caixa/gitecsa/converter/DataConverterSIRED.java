...
/**
 * Classe para conversão de datas do SIRED para fazer a validação das datas no server-side.
 * 
 * @author jteixeira
 * 
 */
@FacesConverter("converter.DataConverterSIRED")
public class DataConverterSIRED extends DateTimeConverter {

    public static final String MAP_DATA_INVALIDA = "MAP_DATA_INVALIDA";

    public DataConverterSIRED() {
    ...
    /**
     * Metodo preenche o map dataInvalida com o id do componente e booleano que informa se a data informada pelo usuario e invalida
     * 
     * @param component
     * @param dataInvalida
     * @param pIsDataValida
    ...
    public static void setMapDataInvalidaSessao(Map<String, Boolean> map) {
        ...
        session.setAttribute(DataConverterSIRED.MAP_DATA_INVALIDA, map);
    }
