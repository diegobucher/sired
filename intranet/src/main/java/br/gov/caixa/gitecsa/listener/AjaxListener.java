...
public class AjaxListener implements PhaseListener {
    ...
    /**
     * Classe Listener para interceptar todas as requisições Ajax e recarregar o javaScript da tela atualizada.
     */
    ...
    public void beforePhase(PhaseEvent pEvento) {
        ...
        if (ajaxRequest) {
            OmniPartialViewContext requestContext = (OmniPartialViewContext) FacesContext.getCurrentInstance().getAttributes()
                    .get(Constantes.OMNI_PARTIAL_VIEW_CONTEXT);
