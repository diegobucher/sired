package br.gov.caixa.gitecsa.validator;
...
public class DataValidator implements Validator {
    ...
    /*
     * @Override public void validate(FacesContext arg0, UIComponent arg1, Object arg2) { if (!Util.isNull(arg2) &&
     * !Util.isEmptyString(arg2.toString()) && !validaData(String.valueOf(arg2))) { FacesMessage message = new FacesMessage();
     * message.setSeverity(FacesMessage.SEVERITY_ERROR); message.setSummary("Intervalo de data inválido."); refresh(); throw new
    ...
    public static boolean validaData(String data) {
         ...
         * try {
         * 
         * return true; } catch (SicppException e) { return false; }
         */
    ...
    public void validate(FacesContext context, UIComponent component, Object value) {
        if (!Util.isNullOuVazio(value)) {
            ...
            /**
             * This date regex is similar to the first one, but with the difference of matching only the whole string. So "01-01-2000-12345"
             * won't pass with a match. Keep in mind that String.matches tries to match only the whole string.
             */
    ...
    /**
     * Checks if the date format is a valid. Uses the regex pattern to match the date first. Than additionally checks are performed on the
     * boundaries of the days taken the month into account (leap years are covered).
     * 
     * @param date
